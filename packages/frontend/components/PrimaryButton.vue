...
<template>
  ...
  >
    <div
      class="flex-1 bg-primary py-4 pl-10 pr-5 text-center font-display text-xl font-bold uppercase text-black shadow-solid4 transition-all group-hover:shadow-solid2"
    >
      <slot />
    </div>
